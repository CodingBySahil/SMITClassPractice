...
for (let i = 0; i < 30; i++) {
  ...
  descriptionText.innerHTML =
    "This post is done by Muhammad Sahil by using javaScript There is nothing included by HTML in this page. Everything here is come by javascript and styling are from the css style sheet.";
